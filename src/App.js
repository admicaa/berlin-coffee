  ...
  render() {
    ...
    return (<div className='App'>
      ...
      <header className='header' role="banner">
        <h2 className='header-title'>Berlin Coffee shops</h2>
      </header>
      <main className="main-container">
        ...
        <section id='googleMap' className="right-side-bar">{(!this.state.googleMapError|| this.state.isOnline || !this.state.fetchError)?
