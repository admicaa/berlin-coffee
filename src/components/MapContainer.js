          ...
          <InfoWindow
            ...
            visible={this.state.isInfoWindowOpen}
                    ...
                    <div>
                      ...
                      <p>{details.length !== 0 && details[0].location ? details[0].location.address : undefined}<br/> {details.length !== 0 ? details[0].location.formattedAddress[1] : undefined}</p>
                      <p>{details.length !== 0 && details[0].hours? details[0].hours.status : undefined}</p>
                      <p>{details.length !== 0 && details[0].contact? details[0].contact.formattedPhone : undefined}</p>
